...
export default function Home() {
  return (
    <main className="text-white pt-5 gap-y-[50px] flex flex-col items-center w-screen bg-black min-h-screen">
      <NavBarHome />
      <div className="flex w-full gap-x-[25px] items-center px-5">
        <div className="h-[70%] w-[50%] bg-slate-600  overflow-hidden shadow-sm shadow-white/15">
         
          <img className="w-full h-auto object-contain " src="./landing page.jpg" alt="image" />
        </div>

        <div className="flex-1 flex flex-col max-h-[560px] min-h-[530px] h-full pt-5 items-center justify-start w-5/12 px-4 py-2">
          <div className="flex flex-col gap-y-1">
            ...
            <div className="text-left mt-4 text-xl font-light leading-7">
